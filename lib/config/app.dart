...
class Config {
  ...
  /// Generated by SiteNative 18-06-2022 09:56:18
  /// App UID: 3f78df7f-73d1-7bd9-0b22-5e1ae8737373
  /// Version: https://imdent.ru/backend/
  /// API server: {VERSION}

  /// *** App config *** ///
  // App name
  static String appName = "https://gamejoy.su/";
  // App link
  static String appLink = "https://gamejoy.su/";
  ...
  // Signing
  static String osSigning = "ed6201d4a71f500553b3cf814c90c705e1c29d5626041b9ed97d06f4eac494c7";
  // Enabled android?
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "https://imdent.ru/",icon: "albums-outline.svg",type: ActionType.internal,value: "https://imdent.ru/",),
